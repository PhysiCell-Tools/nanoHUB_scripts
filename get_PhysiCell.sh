...
# To use it, you should specify which version should be downloaded, otherwise it downloads latest version. Example usage:  bash get_PhysiCell.sh 1.6.0
...
# Gaining information about the current version
git_Ver=$(wget --no-check-certificate https://raw.githubusercontent.com/MathCancer/PhysiCell/master/VERSION.txt -q -O -)
